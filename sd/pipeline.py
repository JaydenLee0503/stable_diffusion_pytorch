...
def generate(prompt: str, 
    ...
    with torch.no_grad():
        ...
        for i, timestep in enumerate(timesteps):
            ...
            latents = sampler.step(latents, model_output, timestep)
        ...
        # (Batch_Size, 4, Latents_Height, Latents_Width) -> (Batch_Size, Latents_Height, Latents_Width, 4)
...
def get_time_embedding(timestep):
    ...
    if input_image is not None:
        cond["init_image"] = input_image
        cond["strength"] = strength

    uncond = {
        "prompt": [uncond_prompt] * batch_size
    }
